...
if config_dialog.OK:
    ...
    test= int(config_dialog.data[1]) # make sure this is int
else:
...
base_dir='/Users/antoniahoidal/Desktop/Cosan/Projects/test_scan_params/Pinel_localizer/'
...
#print task_order
ITIs=[2.4, 3.3, 3.0, 2.7, 3.6, 3.0, 2.7, 3.0, 3.0, 3.0, 3.3, 2.4, 3.6, 2.7, 3.0, 3.3, 2.7, 3.0, 2.7, 3.3, 2.7, 3.6, 3.0, 2.4, 3.6, 3.0, 2.4, 3.0, 3.6, 2.7, 3.3, 3.0, 3.0, 3.0, 3.0, 3.0, 2.4, 3.3, 3.0, 2.7, 3.3, 2.7, 3.6, 2.4, 3.6, 2.7, 2.7, 3.0, 3.3, 2.7, 3.6, 3.0, 3.0, 3.0, 2.4, 3.3, 2.7, 3.3, 3.0, 3.0, 3.0, 3.3, 2.4, 3.3, 3.3, 3.0, 3.0, 2.7, 3.3, 3.0, 2.7, 3.0, 3.0, 2.7, 3.3, 3.0, 3.0, 3.3, 2.7, 3.3, 3.0, 3.0, 2.4, 3.3, 3.0, 2.7, 3.0, 3.6, 2.7, 3.0, 3.0, 2.7, 3.0, 3.3, 2.7, 3.6, 3.0, 2.4, 3.3, 0.0]
...
for key, task in task_order.items():
    ...
    data_file.write(str(key)+ '\t' + str(preztime) + '\t' + str(duration) + '\t' + str(soa_num) + '\t' + str(ITIs[ITI_counter]) + '\n')
